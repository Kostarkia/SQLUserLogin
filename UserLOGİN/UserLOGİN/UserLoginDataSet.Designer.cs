...
namespace UserLOGİN {
    ...
    public partial class UserLoginDataSet : global::System.Data.DataSet {
        ...
        public partial class UserTableDataTable : global::System.Data.TypedTableBase<UserTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserTableRow AddUserTableRow(int No, string User, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserTableRow FindByNo(int No) {
        ...
        public partial class UserTableRow : global::System.Data.DataRow {
            ...
            public int No {
                get {
                    return ((int)(this[this.tableUserTable.NoColumn]));
                }
                set {
                    this[this.tableUserTable.NoColumn] = value;
                }
            }
            ...
            public string User {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'UserTable\' tablosundaki \'User\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace UserLOGİN.UserLoginDataSetTableAdapters {
    ...
    public partial class UserTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserTable] WHERE (([No] = @Original_No) AND ((@IsNull_User = 1" +
                " AND [User] IS NULL) OR ([User] = @Original_User)) AND ((@IsNull_Password = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserTable] ([No], [User], [Password]) VALUES (@No, @User, @Pas" +
                "sword);\r\nSELECT No, [User], Password FROM UserTable WHERE (No = @No)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserTable] SET [No] = @No, [User] = @User, [Password] = @Password WHERE (([No] = @Original_No) AND ((@IsNull_User = 1 AND [User] IS NULL) OR ([User] = @Original_User)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT No, [User], Password FROM UserTable WHERE (No = @No)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UserLOGİN.Properties.Settings.Default.UserLoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT No, [User], Password FROM dbo.UserTable";
        ...
        public virtual int Fill(UserLoginDataSet.UserTableDataTable dataTable) {
        ...
        public virtual UserLoginDataSet.UserTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserLoginDataSet.UserTableDataTable dataTable = new UserLoginDataSet.UserTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserLoginDataSet.UserTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_No, string Original_User, string Original_Password) {
        ...
        public virtual int Insert(int No, string User, string Password) {
        ...
        public virtual int Update(int No, string User, string Password, int Original_No, string Original_User, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string User, string Password, int Original_No, string Original_User, string Original_Password) {
            return this.Update(Original_No, User, Password, Original_No, Original_User, Original_Password);
        }
    }
